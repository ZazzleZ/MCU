...
import ConfirmUserModal from "./popups/ConfirmUserModal.vue"
import CredentialsModal from "./popups/CredentialsModal.vue"
import StatementModal from "./popups/StatementModal.vue"
import Benutzeranlegen from "./popups/Benutzeranlegen.vue"
...
<template>
  <div class="p-10 space-y-6 ">
    ...
    <div class="container">
      <!-- BUTTON 1 -->
    <button
      class="rounded-lg bg-blue-500 px-6 py-3 text-white"
    ...
    <!-- BUTTON 2 -->
    <button
      class="rounded-lg bg-green-500 px-6 py-3 text-white"
    ...
    <!-- BUTTON 3 -->
    <button
      class="rounded-lg bg-purple-500 px-6 py-3 text-white"
    ...
    <!-- BUTTON 4 -->
    <button
      class="rounded-lg bg-orange-500 px-6 py-3 text-white"
    ...
    <CredentialsModal
      ...
      text="Deine Zugangsdaten wurden erstellt"
      btn="Schließen"
